...
function whasta() {
   ...
   var url= "https://api.whatsapp.com/send?phone=573057694796&text=Hola,%20este%20es%20mi%20pedido,%20gracias%20%0A"+ nombre +"%20"+ apellido +"%0A"+ direccion+"%0A*medio depago*%0A"+pago+"%0A*mi eleccion es*%0A"+catalogo+"%0A*observacion*%0A"+observacion;
   window.open(url);
